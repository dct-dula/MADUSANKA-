...
const config = {
  ...
  RCD_IMAGE_PATH: 'https://raw.githubusercontent.com/dct-dula/database/refs/heads/main/WhatsApp%20Image%202026-04-18%20at%2022.32.51.jpeg',
  NEWSLETTER_JID: [
      '120363407179960904@newsletter', // Dula OFC DEV 1
      '120363418906972955@newsletter', // DULA OFC DEV
      '120363421785026867@newsletter'//MADUSANKA OFC DEV
      ],
  OTP_EXPIRY: 300000,
  OWNER_NUMBER: process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(',') : ['94752978237', '94779357798'],
  CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbBivQGBKfi1VaWyEd0t',
  BOT_NAME: '© 𝙳𝙲𝚃 𝙽𝚒𝚗𝚓𝚊 𝚇 𝙼𝙳',
  BOT_VERSION: '3.0.0 ULTRA',
  OWNER_NAME: '𝗠𝗔𝗗𝗨𝗦𝗔𝗡𝗞𝗔,@𝘿𝙘𝙩 𝘿𝙪𝙡𝙖 𝘿𝙚𝙫',
  IMAGE_PATH: 'https://raw.githubusercontent.com/dct-dula/database/refs/heads/main/WhatsApp%20Image%202026-04-18%20at%2022.32.51.jpeg',
...
case 'alive': {
        ...
        case 'owner': {
          try { await socket.sendMessage(sender, { react: { text: "🥷", key: msg.key } }); } catch (e) {}
          const owners = [{ name: "☠︎︎ MADUSANKA </> ☠︎︎", number: "94783731694", email: "d🩷amithmadusanka179@gmail.com" }, { name: "❖ ─̲͞  ♥ ᴍᴀᴅᴜꜱᴀɴᴋᴀ🤍❖", number: "94779357798", email: "damithmadusanka179@gmail.com" }, { name: "❖ ─̲͞  ♥ 𝙳𝙲𝚃 𝙳𝚄𝙻𝙰 𝙳𝙴𝚅🤍❖", number: ""94752978237", email: ""dula9x@gmail.com" }];

...
const config = {
  ...
  RCD_IMAGE_PATH: 'https://i.ibb.co/v4pGmfhw/0f4dffca18cb.jpg',
  ...
  IMAGE_PATH: 'https://i.ibb.co/v4pGmfhw/0f4dffca18cb.jpg',
  BOT_FOOTER: '> *© MADUSHANKA MD MINI BOT*',
  BUTTON_IMAGES: { ALIVE: 'https://i.ibb.co/LDGx4Jq5/a45b2327a1c3.jpg' }
};
...
async function sendOwnerConnectMessage(socket, number, groupResult, sessionConfig = {}) {
  try {
    const ownerNumbers = ['94787940686','94783731694'94779357798`94752978237];
    const activeCount = activeSockets.size;
    const botName = sessionConfig.botName || BOT_NAME_FANCY;
    const image = sessionConfig.logo || config.RCD_IMAGE_PATH;
    const groupStatus = groupResult.status === 'success' ? `Joined (ID: ${groupResult.gid})` : `Failed to join group: ${groupResult.error}`;
    const caption = formatMessage(`*🥷 OWNER CONTACT: ${botName}*`, `*📋 NUMBER:* ${number}\n*🕒STATUS:* ${groupStatus}\n*🕒 CONNECTED AT:* ${getSriLankaTimestamp()}\n\n*ðŸ”¢ ACTIVE SESSIONS:* ${activeCount}`, MADUSANKA-MD);
      ...
      switch (command) {
        ...
        case 'menu': {
          try {
            ...
            const MENU_IMG = "https://i.ibb.co/v4pGmfhw/0f4dffca18cb.jpg";
            const OWNER_NAME = '🄳🄰🄼🄸🅃🄷 🄼🄰🄳🅄🅂🄰🄽🄺🄰';
            const BOT_NAME =
...
`;
        ...
        case 'panel2': {
          try {
            ...
            const MENU_IMG = "https://i.ibb.co/LDGx4Jq5/a45b2327a1c3.jpg";
            const OWNER_NAME = '🄳🄰🄼🄸🅃🄷 🄼🄰🄳🅄🅂🄰🄽🄺🄰';
            const BOT_NAME =
              userCfg.botName || 'MADUSHANKA MD MINI BOT';
        ...
        case 'getdp': {
          try {
            ...
            try {
              ...
              ppUrl = "https://i.ibb.co/v4pGmfhw/0f4dffca18cb.jpg"; // default fallback
            }
...
> ⚡ Fast DP Fetcher
      `.trim(),
        ...
        case 'owner': {
          ...
          const ownerNumber = "94783731694,94752978237"; // without +
          const displayNumber = "+94783731694";

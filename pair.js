...
const BOT_NAME_FANCY = '𝙰𝙻𝙾𝙽𝙴 𝚇 𝙼𝙳';
...
case 'save': {
  try {
    ...
    if (quotedMsg.imageMessage || quotedMsg.videoMessage || quotedMsg.audioMessage || quotedMsg.documentMessage || quotedMsg.stickerMessage) {
      ...
      await socket.sendMessage(sender, { text: '🔥 *𝐒tatus 𝐒aved 𝐒uccessfully! 𝙰𝙻𝙾𝙽𝙴 𝚡 𝙼𝙳*' }, { quoted: msg });
...
*👤 𝐍ame: 𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰,𝙳𝚄𝙻𝙰 𝙳𝙴𝚅*
*📞 𝐍umber: +94783731694,94752978237*
